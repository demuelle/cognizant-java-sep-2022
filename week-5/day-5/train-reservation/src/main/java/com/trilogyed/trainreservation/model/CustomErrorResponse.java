...
public class CustomErrorResponse {
    ...
    private CustomErrorResponse(String errorMsg, int status, String errorCode, LocalDateTime timestamp) {
    ...
    public static CustomErrorResponse build(HttpStatus status, String message) {
        return new CustomErrorResponse(message, status.value(), status.toString(), LocalDateTime.now());
    }
